...
/// Si la variable $_POST existe ET si elle n'est pas vide
if(isset($_POST) && !empty($_POST)){
    ...
    echo "variable serialisée: ".$serialize;
        
	// je stocke dans un fichier le contenu de $serialize
    ...
    /// (on y stocke ici de la date système)
